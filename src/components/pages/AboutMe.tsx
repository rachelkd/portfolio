    ...
    return (
        <div className='about-me' id='about-me'>
            ...
            <p className='about-me-text'>
                ...
                <span className='bold'>computer science</span> and a minor in{' '}
                <span className='bold'>history and philosophy of science</span>{' '}
                at the{' '}
                <span className='bold highlight-2'>University of Toronto</span>.
                I enjoy developments in technology intersected with health and
                society.
            </p>
            <p className='about-me-text'>Recently, I have been working with:</p>
            ...
            <p className='about-me-text'>
                Peak Diamond 2 in Valorant. Thinks folklore is Taylor Swift’s
                best album. Misses taking her dog on hikes with a roll of Gold
                200 back home in Vancouver, British Columbia.
            </p>
        </div>
    );
};
